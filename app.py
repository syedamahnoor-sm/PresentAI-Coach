...
if "ai_coaching" not in st.session_state:
    st.session_state.ai_coaching = None
# =========================================================
# ANALYSIS RESULTS UI
# =========================================================
...
def display_ai_coaching(coaching):
    """
    Display personalized coaching generated by the
    LangGraph + Gemini PresentAI coaching agent.
    """
    ...
    st.caption(
        "Personalized coaching generated by PresentAI's "
        "multi-step AI reasoning agent."
    )
    ...
    with st.container(
        ...
        headline = coaching.get(
            "headline",
            "Your Presentation Coaching"
        )
            ...
            try:
                ...
                if report is not None:
                    ...
                    try:
                        ...
                        with st.spinner(
                            "AI Coach is reasoning about your presentation..."
                        ):

                            coach = AICoachAgent()

                            coaching = coach.analyze(
                                report
                            )

                            st.session_state.ai_coaching = (
                                coaching
                            )
    ...
    if uploaded_file is not None:
        ...
        if st.button(
            ...
            try:
                ...
                # -------------------------------------------------
                # RUN AGENTIC AI COACH
                # -------------------------------------------------

                if report is not None:
                    try:
                        with st.spinner(
                            "AI Coach is reviewing your presentation..."
                        ):
                            coach = AICoachAgent()
